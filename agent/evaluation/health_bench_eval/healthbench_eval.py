...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        help="Subset name",
        choices=["hard", "consensus", "all"],
    )
    parser.add_argument(
        "--eval_save_dir",
        default="health_bench_eval/eval_results",
        type=str,
    ...
    parser.add_argument(
        ...
        default="health_bench_eval/cached_completions/cached_completions.json",
        type=str,
        help="Path to cached completions",
    )
    ...
    if args.run_mode == "physician_completions":
    ...
    elif args.run_mode == "gpt4_completions":
        gpt4_completions_main(
            num_examples=args.examples,
            n_threads=args.n_threads or 1,
            subset_name=args.subset_name,
        ...
        assert args.cached_completions_path is not None
        cached_completions_main(
            num_examples=args.examples,
            n_threads=args.n_threads or 1,
            subset_name=args.subset_name,
            eval_save_dir=args.eval_save_dir,
            cached_completions_path=args.cached_completions_path,
        )
    else:
